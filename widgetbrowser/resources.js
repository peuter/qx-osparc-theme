qx.$$packageData['0'] = {
  "locales": {
    ...
    "de": {
      ...
      "cldr_date_format_medium": "dd.MM.y",
      ...
      "cldr_date_time_format_y": "y",
      "cldr_date_time_format_yM": "M.y",
      "cldr_date_time_format_yMEd": "E, d.M.y",
      "cldr_date_time_format_yMMM": "MMM y",
      "cldr_date_time_format_yMMMEd": "E, d. MMM y",
      "cldr_date_time_format_yMMMd": "d. MMM y",
      ...
      "cldr_day_stand-alone_narrow_fri": "Fr",
      "cldr_day_stand-alone_narrow_mon": "Mo",
      "cldr_day_stand-alone_narrow_sat": "Sa",
      "cldr_day_stand-alone_narrow_sun": "So",
      "cldr_day_stand-alone_narrow_thu": "Do",
      "cldr_day_stand-alone_narrow_tue": "Di",
      "cldr_day_stand-alone_narrow_wed": "Mi",
      "cldr_month_format_abbreviated_1": "Jan.",
      "cldr_month_format_abbreviated_2": "Feb.",
      "cldr_month_format_abbreviated_3": "März",
      "cldr_month_format_abbreviated_4": "Apr.",
      "cldr_month_format_abbreviated_5": "Mai",
      "cldr_month_format_abbreviated_6": "Juni",
      "cldr_month_format_abbreviated_7": "Juli",
      "cldr_month_format_abbreviated_8": "Aug.",
      "cldr_month_format_abbreviated_9": "Sept.",
      "cldr_month_format_abbreviated_10": "Okt.",
      "cldr_month_format_abbreviated_11": "Nov.",
      "cldr_month_format_abbreviated_12": "Dez.",
      "cldr_month_format_wide_1": "Januar",
      "cldr_month_format_wide_2": "Februar",
      "cldr_month_format_wide_3": "März",
      "cldr_month_format_wide_4": "April",
      "cldr_month_format_wide_5": "Mai",
      "cldr_month_format_wide_6": "Juni",
      "cldr_month_format_wide_7": "Juli",
      "cldr_month_format_wide_8": "August",
      "cldr_month_format_wide_9": "September",
      "cldr_month_format_wide_10": "Oktober",
      "cldr_month_format_wide_11": "November",
      "cldr_month_format_wide_12": "Dezember",
      "cldr_month_stand-alone_narrow_1": "Jan",
      "cldr_month_stand-alone_narrow_2": "Feb",
      "cldr_month_stand-alone_narrow_3": "Mär",
      "cldr_month_stand-alone_narrow_4": "Apr",
      "cldr_month_stand-alone_narrow_5": "Mai",
      "cldr_month_stand-alone_narrow_6": "Jun",
      "cldr_month_stand-alone_narrow_7": "Jul",
      "cldr_month_stand-alone_narrow_8": "Aug",
      "cldr_month_stand-alone_narrow_9": "Sep",
      "cldr_month_stand-alone_narrow_10": "Okt",
      "cldr_month_stand-alone_narrow_11": "Nov",
      "cldr_month_stand-alone_narrow_12": "Dez",
      "cldr_number_decimal_separator": ",",
      "cldr_number_group_separator": ".",
      "cldr_number_percent_format": "#,##0 %",
      "day": [
    ...
    "fr": {
      ...
      "cldr_date_format_short": "dd/MM/y",
      "cldr_date_time_format_Ed": "E d",
      "cldr_date_time_format_Hm": "HH:mm",
      "cldr_date_time_format_Hms": "HH:mm:ss",
      "cldr_date_time_format_M": "L",
      "cldr_date_time_format_MEd": "E dd/MM",
      "cldr_date_time_format_MMM": "LLL",
      "cldr_date_time_format_MMMEd": "E d MMM",
      "cldr_date_time_format_MMMd": "d MMM",
      "cldr_date_time_format_Md": "dd/MM",
      "cldr_date_time_format_d": "d",
      "cldr_date_time_format_hm": "h:mm a",
      "cldr_date_time_format_hms": "h:mm:ss a",
      "cldr_date_time_format_ms": "mm:ss",
      "cldr_date_time_format_y": "y",
      "cldr_date_time_format_yM": "MM/y",
      "cldr_date_time_format_yMEd": "E dd/MM/y",
      "cldr_date_time_format_yMMM": "MMM y",
      "cldr_date_time_format_yMMMEd": "E d MMM y",
      "cldr_date_time_format_yMMMd": "d MMM y",
      "cldr_date_time_format_yMd": "dd/MM/y",
      "cldr_date_time_format_yQ": null,
      "cldr_date_time_format_yQQQ": "QQQ y",
      "cldr_day_format_abbreviated_fri": "ven.",
      "cldr_day_format_abbreviated_mon": "lun.",
      "cldr_day_format_abbreviated_sat": "sam.",
      "cldr_day_format_abbreviated_sun": "dim.",
      "cldr_day_format_abbreviated_thu": "jeu.",
      "cldr_day_format_abbreviated_tue": "mar.",
      "cldr_day_format_abbreviated_wed": "mer.",
      "cldr_day_format_wide_fri": "vendredi",
      "cldr_day_format_wide_mon": "lundi",
      "cldr_day_format_wide_sat": "samedi",
      "cldr_day_format_wide_sun": "dimanche",
      "cldr_day_format_wide_thu": "jeudi",
      "cldr_day_format_wide_tue": "mardi",
      "cldr_day_format_wide_wed": "mercredi",
      "cldr_day_stand-alone_narrow_fri": "ven.",
      "cldr_day_stand-alone_narrow_mon": "lun.",
      "cldr_day_stand-alone_narrow_sat": "sam.",
      "cldr_day_stand-alone_narrow_sun": "dim.",
      "cldr_day_stand-alone_narrow_thu": "jeu.",
      "cldr_day_stand-alone_narrow_tue": "mar.",
      "cldr_day_stand-alone_narrow_wed": "mer.",
      "cldr_month_format_abbreviated_1": "janv.",
      "cldr_month_format_abbreviated_2": "févr.",
      "cldr_month_format_abbreviated_3": "mars",
      "cldr_month_format_abbreviated_4": "avr.",
      "cldr_month_format_abbreviated_5": "mai",
      "cldr_month_format_abbreviated_6": "juin",
      "cldr_month_format_abbreviated_7": "juil.",
      "cldr_month_format_abbreviated_8": "août",
      "cldr_month_format_abbreviated_9": "sept.",
      "cldr_month_format_abbreviated_10": "oct.",
      "cldr_month_format_abbreviated_11": "nov.",
      "cldr_month_format_abbreviated_12": "déc.",
      "cldr_month_format_wide_1": "janvier",
      "cldr_month_format_wide_2": "février",
      "cldr_month_format_wide_3": "mars",
      "cldr_month_format_wide_4": "avril",
      "cldr_month_format_wide_5": "mai",
      "cldr_month_format_wide_6": "juin",
      "cldr_month_format_wide_7": "juillet",
      "cldr_month_format_wide_8": "août",
      "cldr_month_format_wide_9": "septembre",
      "cldr_month_format_wide_10": "octobre",
      "cldr_month_format_wide_11": "novembre",
      "cldr_month_format_wide_12": "décembre",
      "cldr_month_stand-alone_narrow_1": "janv.",
      "cldr_month_stand-alone_narrow_2": "févr.",
      "cldr_month_stand-alone_narrow_3": "mars",
      "cldr_month_stand-alone_narrow_4": "avr.",
      "cldr_month_stand-alone_narrow_5": "mai",
      "cldr_month_stand-alone_narrow_6": "juin",
      "cldr_month_stand-alone_narrow_7": "juil.",
      "cldr_month_stand-alone_narrow_8": "août",
      "cldr_month_stand-alone_narrow_9": "sept.",
      "cldr_month_stand-alone_narrow_10": "oct.",
      "cldr_month_stand-alone_narrow_11": "nov.",
      "cldr_month_stand-alone_narrow_12": "déc.",
      "cldr_number_decimal_separator": {
        "_": "٫",
        "$": {
          "draft": "unconfirmed"
  ...
  "resources": {
    ...
    "osparc/font/LICENSE.txt": [
      null,
      null,
      "txt",
      "osparc.theme"
    ],
    "osparc/font/README-opensans.txt": [
      null,
      null,
      "txt",
      "osparc.theme"
    ],
    "osparc/font/roboto-mono-v6-latin_latin-ext-700.eot": [
      null,
      null,
      "eot",
      "osparc.theme"
    ],
    "osparc/font/roboto-mono-v6-latin_latin-ext-700.svg": [
      null,
      null,
      "svg",
      "osparc.theme"
    ],
    "osparc/font/roboto-mono-v6-latin_latin-ext-700.ttf": [
      null,
      null,
      "ttf",
      "osparc.theme"
    ],
    "osparc/font/roboto-mono-v6-latin_latin-ext-700.woff": [
      null,
      null,
      "woff",
      "osparc.theme"
    ],
    "osparc/font/roboto-mono-v6-latin_latin-ext-700.woff2": [
      null,
      null,
      "woff2",
      "osparc.theme"
    ],
    "osparc/font/roboto-mono-v6-latin_latin-ext-700italic.eot": [
      null,
      null,
      "eot",
      "osparc.theme"
    ],
    "osparc/font/roboto-mono-v6-latin_latin-ext-700italic.svg": [
      null,
      null,
      "svg",
      "osparc.theme"
    ],
    "osparc/font/roboto-mono-v6-latin_latin-ext-700italic.ttf": [
      null,
      null,
      "ttf",
      "osparc.theme"
    ],
    "osparc/font/roboto-mono-v6-latin_latin-ext-700italic.woff": [
      null,
      null,
      "woff",
      "osparc.theme"
    ],
    "osparc/font/roboto-mono-v6-latin_latin-ext-700italic.woff2": [
      null,
      null,
      "woff2",
      "osparc.theme"
    ],
    "osparc/font/roboto-mono-v6-latin_latin-ext-italic.eot": [
      null,
      null,
      "eot",
      "osparc.theme"
    ],
    "osparc/font/roboto-mono-v6-latin_latin-ext-italic.svg": [
      null,
      null,
      "svg",
      "osparc.theme"
    ],
    "osparc/font/roboto-mono-v6-latin_latin-ext-italic.ttf": [
      null,
      null,
      "ttf",
      "osparc.theme"
    ],
    "osparc/font/roboto-mono-v6-latin_latin-ext-italic.woff": [
      null,
      null,
      "woff",
      "osparc.theme"
    ],
    "osparc/font/roboto-mono-v6-latin_latin-ext-italic.woff2": [
      null,
      null,
      "woff2",
      "osparc.theme"
    ...
    "osparc/font/roboto-mono-v6-latin_latin-ext-regular.svg": [
      null,
      null,
      "svg",
      "osparc.theme"
    ...
    "osparc/font/roboto-v18-latin_latin-ext-700.svg": [
      null,
      null,
      "svg",
      "osparc.theme"
    ...
    "osparc/font/roboto-v18-latin_latin-ext-700italic.eot": [
      null,
      null,
      "eot",
      "osparc.theme"
    ],
    "osparc/font/roboto-v18-latin_latin-ext-700italic.svg": [
      null,
      null,
      "svg",
      "osparc.theme"
    ],
    "osparc/font/roboto-v18-latin_latin-ext-700italic.ttf": [
      null,
      null,
      "ttf",
      "osparc.theme"
    ],
    "osparc/font/roboto-v18-latin_latin-ext-700italic.woff": [
      null,
      null,
      "woff",
      "osparc.theme"
    ],
    "osparc/font/roboto-v18-latin_latin-ext-700italic.woff2": [
      null,
      null,
      "woff2",
      "osparc.theme"
    ],
    "osparc/font/roboto-v18-latin_latin-ext-italic.eot": [
      null,
      null,
      "eot",
      "osparc.theme"
    ],
    "osparc/font/roboto-v18-latin_latin-ext-italic.svg": [
      null,
      null,
      "svg",
      "osparc.theme"
    ],
    "osparc/font/roboto-v18-latin_latin-ext-italic.ttf": [
      null,
      null,
      "ttf",
      "osparc.theme"
    ],
    "osparc/font/roboto-v18-latin_latin-ext-italic.woff": [
      null,
      null,
      "woff",
      "osparc.theme"
    ],
    "osparc/font/roboto-v18-latin_latin-ext-italic.woff2": [
      null,
      null,
      "woff2",
      "osparc.theme"
    ...
    "osparc/font/roboto-v18-latin_latin-ext-regular.svg": [
      null,
      null,
      "svg",
      "osparc.theme"
    ...
    "widgetbrowser/blank.html": [
      null,
      null,
      "html",
      "osparc.theme"
    ],
    "widgetbrowser/fo_tester.swf": [
      null,
      null,
      "swf",
      "osparc.theme"
    ],
    "widgetbrowser/loading66.gif": [
      66,
      66,
      "gif",
      "osparc.theme"
    ],
    "widgetbrowser/people.json": [
      null,
      null,
      "json",
      "osparc.theme"
    ],
    "widgetbrowser/tree.json": [
      null,
      null,
      "json",
      "osparc.theme"
    ...
    "qx/icon/Tango/16/apps/internet-feed-reader.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/apps/internet-telephony.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/apps/utilities-calculator.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/apps/utilities-notes.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/apps/utilities-terminal.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/32/apps/media-photo-album.png": [
      32,
      32,
      "png",
      "qx"
    ],
    "qx/icon/Tango/32/apps/office-address-book.png": [
      32,
      32,
      "png",
      "qx"
    ],
    "qx/icon/Tango/32/status/dialog-error.png": [
      32,
      32,
      "png",
      "qx"
    ],
    "qx/icon/Tango/32/status/dialog-information.png": [
      32,
      32,
      "png",
      "qx"
    ...
    "qx/icon/Tango/48/devices/battery.png": [
      48,
      48,
      "png",
      "qx"
    ...
    "qx/icon/Tango/48/devices/display.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Tango/48/devices/drive-harddisk.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Tango/48/devices/drive-optical.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Tango/48/devices/input-keyboard.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Tango/48/devices/input-mouse.png": [
      48,
      48,
      "png",
      "qx"
    ...
    "qx/icon/Tango/48/devices/multimedia-player.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Tango/48/devices/network-wired.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Tango/48/devices/network-wireless.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Tango/48/devices/pda.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Tango/48/devices/phone.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Tango/48/devices/printer.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Tango/48/devices/scanner.png": [
      48,
      48,
      "png",
      "qx"
  ...
  "translations": {
    ...
    "de": {
      ...
      "Recent Colors": "Zuletzt benutzte Farben",
    ...
    "fr": {
      ...
      "one row": "une ligne",
      "%1 rows": "%1 lignes",
      "one of one row": "une ligne sur une",
      "%1 of %2 rows": "%1 lignes sur %2",
      "Presets": "Pré-réglages",
      "Details": "Détails",
      "Preview (Old/New)": "Aperçu (Ancien/Nouveau)",
      "Hex": "Hex",
      "RGB": "RVB",
      "HSB": "TSV",
      ...
      "OK": "OK",
      "Cancel": "Annuler",
      "Color Selector": "Sélecteur de couleurs",
      "Last year": "Année dernière",
      "Last month": "Mois dernier",
      "Next month": "Mois prochain",
      "Next year": "Année prochaine",
      "Reset column widths": "Réinitialiser la largeur des colonnes",
