(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qxc.application.formdemo.FormItems", {
    ...
    members: {
      ...
      __createItems: function __createItems(widget) {
        for (var i = 0; i < 10; i++) {
      ...
      __createItemsVirtual: function __createItemsVirtual(widget) {
      ...
      __createMenuForMenuButton: function __createMenuForMenuButton() {
      ...
      __createMenuForSplitButton: function __createMenuForSplitButton() {
        var menu = new qx.ui.menu.Menu();
  ...
  qxc.application.formdemo.FormItems.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=FormItems.js.map?dt=1552033895496