(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("widgetbrowser.pages.Embed", {
    ...
    construct: function construct() {
      ...
      this.add(this.__grid, { width: "100%",
        height: "100%" });
    ...
    members: {
      ...
      initWidgets: function initWidgets() {
        ...
        widgets.push(flash);
        this.__grid.add(flash, { row: 1,
          column: 0,
          colSpan: 2 });

        // Canvas
        label = new qx.ui.basic.Label("Canvas");
        this.__grid.add(label, { row: 2,
          column: 0 });
        if (qx.core.Environment.get("html.canvas")) {
          ...
          widgets.push(canvas);
          this.__grid.add(canvas, { row: 3,
            column: 0 });
        } else {
          this.__grid.add(new qx.ui.basic.Label("Browser does not support canvas"), { row: 3,
            column: 0 });
        }
        ...
        this.__grid.add(htmlContainer, { row: 3,
          column: 1 });
  ...
  widgetbrowser.pages.Embed.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Embed.js.map?dt=1552033892513