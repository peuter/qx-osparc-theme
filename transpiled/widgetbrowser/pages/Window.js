(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("widgetbrowser.pages.Window", {
    ...
    construct: function construct() {
      ...
      this.add(this.__desktop, { edge: 0,
        top: 0 });
    ...
    members: {
      ...
      initWidgets: function initWidgets() {
        ...
        widgets.push(w1);
        w1.open();
        this.__desktop.add(w1, { left: 0,
          top: 0 });

        w2 = this.__createWindow2();
        widgets.push(w2);
        w2.open();
        this.__desktop.add(w2, { left: 300,
          top: 100 });

        w3 = this.__createWindow3();
        widgets.push(w3);
        w3.open();
        this.__desktop.add(w3, { left: 80,
          top: 230 });
      },

      __createWindow1: function __createWindow1() {
        // Create the Window
      ...
      __createWindow2: function __createWindow2() {
      ...
      __createWindow3: function __createWindow3() {
      ...
      __getModalWindow1: function __getModalWindow1() {
       ...
       */
      __getModalWindow2: function __getModalWindow2() {
  ...
  widgetbrowser.pages.Window.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Window.js.map?dt=1552033892465