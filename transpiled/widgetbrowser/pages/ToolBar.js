(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("widgetbrowser.pages.ToolBar", {
    ...
    members: {
      ...
      initWidgets: function initWidgets() {
        ...
        this.add(label, { left: 0,
          top: 0 });
        this.add(this.getToolBar(), { left: 0,
          top: 20 });

        // Menu (with slidebar)
        this.add(this.getMenuWithSlideBar(), { left: 0,
          top: 70 });
        ...
        this.add(label, { left: 0,
          top: 210 });
        this.add(this.getMenuBar(), { left: 0,
          top: 230 });
        ...
        this.add(label, { left: 0,
          top: 280 });
        this.add(this.getToolBarExclude(), { left: 0,
          top: 300 });
        ...
        this.add(label, { left: 0,
          top: 370 });
        this.add(this.getContextMenuWidget(), { left: 0,
          top: 390 });
      },
      ...
      getToolBar: function getToolBar() {
        ...
        // SplitButton
        var splitButton = new qx.ui.toolbar.SplitButton("Toolbar SplitButton", "@MaterialIcons/skip_previous/16", this.getSplitButtonMenu());
        splitButton.setToolTip(new qx.ui.tooltip.ToolTip("Toolbar SplitButton"));
        this._widgets.push(splitButton);

        // Button
        var button = new qx.ui.toolbar.Button("Toolbar Button", "@MaterialIcons/create/16");
        button.setToolTip(new qx.ui.tooltip.ToolTip("Toolbar Button"));
        this._widgets.push(button);

        // CheckBox
        var checkBox = new qx.ui.toolbar.CheckBox("Toggle", "@MaterialIcons/format_underlined/16");
        checkBox.setToolTip(new qx.ui.tooltip.ToolTip("Toolbar CheckBox"));
        this._widgets.push(checkBox);

        // RadioButton
        var radioButton1 = new qx.ui.toolbar.RadioButton("Left", "@MaterialIcons/format_align_left/16");
        radioButton1.setToolTip(new qx.ui.tooltip.ToolTip("Toolbar RadioButton"));
        this._widgets.push(radioButton1);

        var radioButton2 = new qx.ui.toolbar.RadioButton("Center", "@MaterialIcons/format_align_center/16");
      ...
      getSplitButtonMenu: function getSplitButtonMenu() {
      ...
      getButtonMenu: function getButtonMenu() {
        var menu = new qx.ui.menu.Menu();
        ...
        // MenuButton
        var button = new qx.ui.menu.Button("Menu MenuButton", "@MaterialIcons/menu/16");
        this._widgets.push(button);
      ...
      getToolBarExclude: function getToolBarExclude() {
        var frame = new qx.ui.container.Composite(new qx.ui.layout.Grow());
        frame.setDecorator("main");
        ...
        for (var j = 0; j < classes.length; j++) {
          ...
          for (var i = 0; i < 5; i++) {
            var button = new classes[j](String(i));
            this._widgets.push(button);
      ...
      //
      // (Evil hacks below)
      getMenuWithSlideBar: function getMenuWithSlideBar() {
        ...
        subContainer.add(label, { left: 0,
          top: 0 });
        subContainer.add(buttonMenu, { left: 0,
          top: 0 });

        label.addListener("appear", function () {
          buttonMenu.openAtPoint({ left: 0,
            top: 20 });
        });
       ...
       */
      getContextMenuWidget: function getContextMenuWidget() {
  ...
  widgetbrowser.pages.ToolBar.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=ToolBar.js.map?dt=1552033892384