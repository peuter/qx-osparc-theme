(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Bootstrap.define("qxWeb", {
    ...
    members: {
       ...
       */
      indexOf: function indexOf(elem, fromIndex) {
        if (!elem) {
          return -1;
        }
       ...
       * @return {q} The collection for chaining
       */
      _forEachElement: function _forEachElement(func, ctx) {
       ...
       * @return {q} The collection for chaining
       */
      _forEachElementWrapped: function _forEachElementWrapped(func, ctx) {
...
//# sourceMappingURL=qxWeb.js.map?dt=1552033897112