(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Theme.define("osparc.theme.osparcdark.Appearance", {
    appearances: {
      /*
      ---------------------------------------------------------------------------
        CORE
      ...
      */
      ...
      "label": {
        style: function style(states) {
          return { textColor: states.disabled ? "text-disabled" : undefined };
        }
      },
      ...
      */
      ...
      "hover-button": {
        ...
        style: function style(states) {
          return { decorator: states.hovered ? "button-hover" : undefined };
        }
      },
      ...
      "table-header-cell": {
        ...
        style: function style(states) {
          return {
            ...
            paddingLeft: 5,
            cursor: states.disabled ? undefined : "pointer",
            sortIcon: states.sorted ? osparc.theme.osparcdark.Image.URLS["table-" + (states.sortedAscending ? "ascending" : "descending")] : undefined
          };
        }
      },
      ...
      */
      ...
      "splitpane/splitter/knob": {
        style: function style(states) {
          return {
            source: osparc.theme.osparcdark.Image.URLS["knob-" + (states.horizontal ? "horizontal" : "vertical")],
            padding: 0
          };
        }
      },
      ...
      */
      ...
      "menu-slidebar/button-backward": {
        ...
        style: function style(states) {
          return {
            icon: osparc.theme.osparcdark.Image.URLS["arrow-up" + (states.hovered ? "-invert" : "")]
          };
        }
      },
      ...
      "menu-slidebar/button-forward": {
        ...
        style: function style(states) {
          return {
            icon: osparc.theme.osparcdark.Image.URLS["arrow-down" + (states.hovered ? "-invert" : "")]
          };
        }
      },
      ...
      "menu-button/arrow": {
        ...
        style: function style(states) {
          return {
            source: osparc.theme.osparcdark.Image.URLS["arrow-right" + (states.selected ? "-invert" : "")],
            alignY: "middle"
          };
        }
      },
      ...
      */
      ...
      "scrollarea/corner": {
        style: function style(states) {
          return { backgroundColor: "background-main" };
        }
      },
      ...
      */
      ...
      "tree-folder/open": {
        ...
        style: function style(states) {
          return {
            source: states.opened ? osparc.theme.osparcdark.Image.URLS["tree-minus"] : osparc.theme.osparcdark.Image.URLS["tree-plus"],
            textColor: states.selected ? "text-selected" : "text"
          };
        }
      },
      ...
      "tree-folder": {
        style: function style(states) {
          ...
          return {
            padding: [2, 8, 2, 5],
            icon: states.opened ? osparc.theme.osparcdark.Image.URLS["folder-open"] : osparc.theme.osparcdark.Image.URLS["folder"],
            backgroundColor: backgroundColor,
            textColor: states.selected ? "text-selected" : "text",
      ...
      */
      ...
      "window-small-cap/minimize-button": {
        ...
        style: function style(states) {
          return { icon: osparc.theme.osparcdark.Image.URLS["window-minimize"] + "/14" };
        }
      },
      ...
      "window-small-cap/restore-button": {
        ...
        style: function style(states) {
          return { icon: osparc.theme.osparcdark.Image.URLS["window-restore"] + "/14" };
        }
      },
      ...
      "window-small-cap/maximize-button": {
        ...
        style: function style(states) {
          return { icon: osparc.theme.osparcdark.Image.URLS["window-maximize"] + "/14" };
        }
      },
      ...
      "window-small-cap/close-button": {
        ...
        style: function style(states) {
          return { icon: osparc.theme.osparcdark.Image.URLS["window-close"] + "/14" };
        }
      },
      /*
      ---------------------------------------------------------------------------
  ...
  osparc.theme.osparcdark.Appearance.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Appearance.js.map?dt=1552033884454