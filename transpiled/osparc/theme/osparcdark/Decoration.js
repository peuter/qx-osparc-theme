(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Theme.define("osparc.theme.osparcdark.Decoration", {
    ...
    decorations: {
      ...
      "button-box-pressed": {
        ...
        style: { backgroundColor: "button-box-pressed" }
      },
      ...
      "button-box-focused": {
        ...
        style: { color: "background-selected" }
      },
      ...
      */
      ...
      "scroll-knob-pressed": {
        ...
        style: { backgroundColor: "scrollbar-active" }
      },
      ...
      "menubar-button-hovered": {
        style: { backgroundColor: "material-button-background-hovered" }
      },

      "menubar-button-pressed": {
        include: "menubar-button-hovered",

        style: { backgroundColor: "material-button-background-pressed" }
      },
...
//# sourceMappingURL=Decoration.js.map?dt=1552033884105