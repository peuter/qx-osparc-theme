(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qx.ui.form.validation.Manager", {
    ...
    members: {
      ...
      validate: function validate() {
        ...
        for (var i = 0; i < this.__formItems.length; i++) {
          ...
          var validatorResult = this._validateItem(this.__formItems[i], formItem.getValue());
...
//# sourceMappingURL=Manager.js.map?dt=1552033901811