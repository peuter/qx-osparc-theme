...
(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qx.ui.treevirtual.SimpleTreeDataModel", {
    ...
    */
    ...
    members: {
      ...
      prune: function prune(nodeReference, bSelfAlso) {
        ...
        if ((typeof nodeReference === "undefined" ? "undefined" : _typeof(nodeReference)) == "object") {
          node = nodeReference;
          nodeId = node.nodeId;
      ...
      move: function move(moveNodeReference, parentNodeReference) {
        ...
        if ((typeof moveNodeReference === "undefined" ? "undefined" : _typeof(moveNodeReference)) == "object") {
        ...
        if ((typeof parentNodeReference === "undefined" ? "undefined" : _typeof(parentNodeReference)) == "object") {
      ...
      setData: function setData(nodeArr) {
        if (nodeArr instanceof Array) {
          ...
          throw new Error("Expected array of node objects or null/undefined; got " + (typeof nodeArr === "undefined" ? "undefined" : _typeof(nodeArr)));
        }
...
//# sourceMappingURL=SimpleTreeDataModel.js.map?dt=1552033897949