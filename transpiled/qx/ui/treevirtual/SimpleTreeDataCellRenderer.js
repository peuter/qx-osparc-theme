(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qx.ui.treevirtual.SimpleTreeDataCellRenderer", {
    ...
    members: {
      ...
      _getIndentSymbol: function _getIndentSymbol(column, node, bUseTreeLines, bAlwaysShowOpenCloseSymbol, bExcludeFirstLevelTreeLines) {
        ...
        if (column < node.level - 1) {
          ...
          // bUseTreeLines
          return bUseTreeLines && !node.lastChild[column] ? STDCR.__icon.line : { icon: this.BLANK };
        }
...
//# sourceMappingURL=SimpleTreeDataCellRenderer.js.map?dt=1552033898005