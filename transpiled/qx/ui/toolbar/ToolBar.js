(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qx.ui.toolbar.ToolBar", {
    ...
    members: {
      ...
      */
      ...
      _add: function _add(child, options) {
        qx.ui.toolbar.ToolBar.prototype._add.base.call(this, child, options);
      ...
      _addAt: function _addAt(child, index, options) {
        qx.ui.toolbar.ToolBar.prototype._addAt.base.call(this, child, index, options);
        // sync the show property (bug #6743) - but only if show wasn't explicitly set for the child (bug #6823)
        if (child.setShow && !qx.util.PropertyUtil.getUserValue(child, "show")) {
          child.setShow(this.getShow());
        }
      ...
      _addBefore: function _addBefore(child, before, options) {
        qx.ui.toolbar.ToolBar.prototype._addBefore.base.call(this, child, before, options);
        // sync the show property (bug #6743) - but only if show wasn't explicitly set for the child (bug #6823)
        if (child.setShow && !qx.util.PropertyUtil.getUserValue(child, "show")) {
          child.setShow(this.getShow());
        }
      ...
      _addAfter: function _addAfter(child, after, options) {
        qx.ui.toolbar.ToolBar.prototype._addAfter.base.call(this, child, after, options);
        // sync the show property (bug #6743) - but only if show wasn't explicitly set for the child (bug #6823)
        if (child.setShow && !qx.util.PropertyUtil.getUserValue(child, "show")) {
          child.setShow(this.getShow());
        }
...
//# sourceMappingURL=ToolBar.js.map?dt=1552033895565