...
(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Bootstrap.define("qx.core.Assert", {
    statics: {
      __logError: true,
      ...
      assertObject: function assertObject(value, msg) {
        var condition = value !== null && (qx.lang.Type.isObject(value) || (typeof value === "undefined" ? "undefined" : _typeof(value)) === "object");
      ...
      */
      ...
      assertType: function assertType(value, type, msg) {
        ...
        (typeof value === "undefined" ? "undefined" : _typeof(value)) === type || this.__fail(msg || "", "Expected value to be typeof '", type, "' but found ", value, "!");
      },
...
//# sourceMappingURL=Assert.js.map?dt=1552033887668