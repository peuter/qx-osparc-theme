...
(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Bootstrap.define("qx.Theme", {
    statics: {
      /*
      ---------------------------------------------------------------------------
         PUBLIC API
      ...
      __validateConfig: function __validateConfig(name, config) {
        ...
        if (config.meta) {
          ...
          for (var key in config.meta) {
            ...
            if ((typeof value === "undefined" ? "undefined" : _typeof(value)) !== this.__metaKeys[key]) {
              throw new Error('The type of the key "' + key + '" inside the meta block is wrong.');
            }

            if (!((typeof value === "undefined" ? "undefined" : _typeof(value)) === "object" && value !== null && value.$$type === "Theme")) {
...
//# sourceMappingURL=Theme.js.map?dt=1552033883941